    ...
    return (
        <header className="flex flex-col w-full">
            <div className="flex flex-row items-center justify-center w-full px-2 py-1 bg-brand-teal">
                <img src="/assets/icons/CaseM.png" alt="case" />
                <p className="px-2 text-white">Overseas trip? Get the latest information on travel guides</p>
                 <Button 
                    text="More info" 
            ...
            <div className="flex flex-row items-center w-full px-2 py-2">
                <div className="items-start px-4 py-2">
                    <a href="#"><img src="/assets/icons/alxlogo.svg" alt="ALX logo" width={150} height={150} className="p-3" /></a>
